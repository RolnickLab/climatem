...
class ClimateDataModule(LightningDataModule):
    ...
    def __init__(
        ...
        use_separate_forcings: bool = False,
        forcing_amplification: float = 1.2,
        forcing_conditioning: str = "raw",
        ...
        n_co2_latents: int = 1,
        n_aerosol_latents: int = 2,
        co2_effect_strength: float = 0.25,
        aerosol_effect_strength: float = 0.20,
        noise_ar1: bool = True,
        ...
        self.test_set_names: Optional[List[str]] = [
            f"{scenario}_{model}" for scenario in test_scenarios for model in self.test_models
        ]
    ...
    def setup(self, stage: Optional[str] = None):
        ...
        if stage in ["fit", "validate", None]:
            ...
            if len(self.hparams.train_models) > 1:
                log.info("Not yet supported for multiple models in training. Only loading first model.")
