...
class ClimateDataModule(LightningDataModule):
    ...
    def setup(self, stage: Optional[str] = None):
        ...
        if stage in ['fit', 'validate', None]:
            ...
            full_ds = ClimateDataset(years=self.hparams.train_years, historical_years=self.hparams.train_historical_years, mode='train+val', scenarios=self.hparams.train_scenarios, climate_model=train_model, load_data_into_mem=self.hparams.load_train_into_mem, **dataset_kwargs)
