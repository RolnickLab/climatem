...
class TrainingLatent:
    ...
    def __init__(
        ...
        with torch.no_grad():
            ...
            if self.latent:
                ...
                # the two-forcing version (savar): this one needs to be confirmed
                if self.instantaneous:
    ...
    def train_with_QPM(self):  # noqa: C901
        ...
        self.ALM_ortho_aerosol_forcing = ALM(
            ...
            dim_gamma=(self.model.n_forced_latents_aerosol, self.model.n_forced_latents_aerosol),  # Only aerosol
            valid_freq=self.train_params.valid_freq,
        )
    ...
    def train_step(self):  # noqa: C901
        ...
        if y_aerosol is not None:
            ...
            if self.iteration == 1:
                print(
                    f"Input x shape {x.shape}, y shape {y.shape}, y_co2 shape {y_co2.shape}, y_aerosol shape {y_aerosol.shape}"
                )
    ...
    def valid_step(self):  # noqa: C901  # noqa: C901
        ...
        with torch.no_grad():
            ...
            del x_bis, y_pred, nll_bis, recons_bis, kl_bis, gmst_loss_bis, forcing_aerosol_bis, forcing_co2_bis
    ...
    def get_nll(
        ...
        gmst_loss = other_losses["gmst_loss"]
