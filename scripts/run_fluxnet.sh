...
#SBATCH --job-name=run_fluxnet                                         # Set name of job
#SBATCH --output=run_fluxnet_output.txt                                  # Set location of output file
#SBATCH --error=run_fluxnet_error.txt                                    # Set location of error file
...
accelerate launch \
    ...
    --num_machines=1 \
    --gpu_ids='all' \
    $HOME/causal_model/climatem/scripts/main_fluxnet.py