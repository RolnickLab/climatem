...
accelerate launch \
    ...
    --num_machines=1 \
    --gpu_ids='all' \
    $HOME/dev/climatem/scripts/rollout_bf.py --config-path params.json --exp-id "var_ts_scen_piControl_nlinmix_True_nlindyn_True_tau_5_z_90_futt_1_ldec_1_lr_0.0001_bs_128_20260301_055455"
